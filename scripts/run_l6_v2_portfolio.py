...
def parse_args():
    ...
    ap.add_argument("--shared-state-file", type=Path, default=None,
                    help="Path to a pickle cache from scripts/pipeline_core.py. "
                         "When set, close/trade panels and benchmark are loaded "
                         "from the cache instead of disk (Phase 2 load-once).")
