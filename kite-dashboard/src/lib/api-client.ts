...
export async function getIndexReturns() {
  ...
  // require_gate_role_when_private on it (R-028), and a tokenless call
  // has 401'd ever since. Sending the token is correct in both modes:
  // the backend ignores it when PRIVATE_MODE is off.
