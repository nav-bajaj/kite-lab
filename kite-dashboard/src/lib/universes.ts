...
export const UNIVERSES: Record<UniverseId, Universe> = {
  om25_v3: {
    ...
    shortName: "Quality",
    description: "Regime-aware quality momentum on Nifty 250, with defensive rotation in bear regimes",
    stocks: 25,
  ...
  combo_defensive: {
    ...
    shortName: "Defensive",
    description: "50/50 Core + Quality blend holding 50% cash in bear regimes, for reduced drawdowns",
    stocks: 24,
  ...
  nifty100: {
    ...
    shortName: "Large-Cap",
    description: "Nifty 100 momentum, large-cap only with lower volatility (admin-only)",
    stocks: 100,
