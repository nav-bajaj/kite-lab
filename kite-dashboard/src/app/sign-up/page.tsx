...
export const metadata = {
  title: "Get beta access — Marketworks",
};

// Same passwordless flow as /sign-in (first verification creates the
// account); this route keeps the marketing CTA copy.
      ...
      <div className="relative z-10 flex flex-1 flex-col items-center justify-center gap-8 px-6 pb-20">
        <div className="flex max-w-[420px] flex-col items-center gap-3 text-center">
          ...
          <p className="text-[15px] leading-[1.55] text-muted-foreground">
            Free during beta. Access the model portfolios and the daily
            insight engine.
          </p>
        </div>
