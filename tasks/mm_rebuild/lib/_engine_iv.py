...
# MM §9 COPY of scripts/_clean_engine.py (2026-09-10) with one additive hook, `size_weights`, for inverse-volatility sizing.
# Production engine untouched. With size_weights=None the behaviour is byte-identical (verified in phase9).
