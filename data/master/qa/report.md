...
- calendar: 1326 files checked, 0 with non-midnight, duplicate or off-calendar dates
- bad prints: 4437 one-day spike-and-revert rows with no corporate action nearby; Kite shows the same move on 2399 (a real move, not a print), disagrees on 79 (a print on one side), no Kite on 1959
