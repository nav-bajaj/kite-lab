...
Promoted from tasks/corporate_actions_fix/ca_lib.py (2026-08-23); the
task copy remains for the research tools. Consumed by
scripts/reconcile_price_integrity.py (the daily guard).
